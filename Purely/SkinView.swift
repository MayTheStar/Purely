                ...
                VStack(spacing: 20) {
                    ...
                    Button(action: {
                        ...
                        Text("Next")
                            ...
                            .padding()
                            .background(Color(.accent)) // لون الزر
                            .cornerRadius(10)
                    }
                    .padding(.horizontal, 30)
                    .padding(.top, 20)
                    
                    // خيار "Not Sure" مع التنقل إلى صفحة الأسئلة
...
struct SkinOptionView: View {
    ...
    var body: some View {
        Button(action: {
            ...
            .background(selectedSkinType == title ? Color(.lightGreen) : Color.white)
            .cornerRadius(12)
            .overlay(
